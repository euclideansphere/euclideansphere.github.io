    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Cloud Infrastructure / DevOps}
          {Pitch, plan, and lead project to standardize all AWS infrastructure deployment and CI/CD through Github Actions, Serverless (devops tool), Terraform (IaC), and Docker to eliminate clickops deployment error.}
