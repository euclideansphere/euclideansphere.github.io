    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Cloud Infrastructure / DevOps}
          {Pitch, plan, and lead project to standardize all AWS infrastructure deployment and CI/CD through Terraform (IaC) and Docker, eliminating clickops deployment error.}
