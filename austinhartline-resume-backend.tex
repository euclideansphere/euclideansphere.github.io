  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Javascript, Node}
          {Build full stack features in a React-Native mobile app and React web app backed by a GraphQL NestJS (NodeJS) backend.}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        % \resumeItem{Testing}
        %   {Write tests using Jest, RSpec, DBT test, and in-house open-source software testing solutions.}
        \resumeItem{Design}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        %   {Identify and fix several bugs in Terraform AWS Provider.}
        \resumeItem{DbUp}
